...
client.on("message", message =>{
    if(blacklistedusers.includes(message.author.id) && message.content.startsWith(conf.prefix)){
        message.reply("you are blacklisted from spacemod!")
        allowcmd = true
    }
    else{
        allowcmd = false
